...
**Path**: `04-analytics-engineering/dbt_cloud_setup.md`
**Size**: 5,663 bytes
**Lines**: 91
...
**Sections (5)**: How to setup dbt cloud with bigquery, Create a BigQuery service account , Create a dbt cloud project , Review your project settings, (Optional) Link to your github account

---
*Generated: 2025-11-15T20:48:44.320700*
