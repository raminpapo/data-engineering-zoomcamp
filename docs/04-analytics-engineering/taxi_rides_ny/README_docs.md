...
**Path**: `04-analytics-engineering/taxi_rides_ny/README.md`
**Size**: 2,231 bytes
**Lines**: 38
...
**Sections (5)**: How to run this project , About the project, Workflow, Execution, dbt resources:

---
*Generated: 2025-11-15T20:48:44.329264*
