...
- **Lines**: 1,069
- **Extension**: `.py`
- **Last Modified**: 2025-11-15T19:49:40.814323
...
- **`is_binary_file(self, filepath)`**
- **`scan_repository(self)`**
- **`extract_keywords(self, content, filepath)`**
- **`safe_read_file(self, filepath)`**
- **`generate_file_docs(self, filepath)`**
- **`generate_file_keywords(self, filepath)`**
- **`get_language_for_file(self, filepath)`**
- **`generate_overview(self, filepath, content)`**
- **`generate_detailed_analysis(self, filepath, content)`**
- **`generate_usage_examples(self, filepath, content)`**
- **`find_related_files(self, filepath, content)`**
- **`generate_perf_security_notes(self, filepath, content)`**
- **`generate_testing_notes(self, filepath, content)`**
- **`get_keyword_context(self, keyword, content)`**
- **`generate_binary_file_doc(self, filepath)`**
- **`process_all_files(self)`**
- **`generate_folder_docs(self, folder_path)`**
...
ℹ️ Multiple loops detected - consider optimization


## Testing & Validation

- Uses pytest/unittest framework
- Uses JavaScript testing framework
