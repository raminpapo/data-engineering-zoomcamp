...
**Sections (7)**: Week 2 Homework, Question 1: Start date for the Yellow taxi data (1 point), Question 2: Frequency for the Yellow taxi data (1 point), Re-running the DAGs for past dates, Question 3: DAG for FHV Data (2 points), Question 4: DAG for Zones (2 points), Submitting the solutions

---
*Generated: 2025-11-15T20:48:44.133181*
