# Documentation: streaming_confluent.py
...
- **Lines**: 100
- **Extension**: `.py`
- **Last Modified**: 2025-11-15T19:46:38.218125
...
org.apache.kafka.common.security.plain.PlainLoginModule required username="{CONFLUENT_CLOUD_CONFIG['sasl.username']}" password="{CONFLUENT_CLOUD_CONFIG['sasl.password']}";
...
- `CONFLUENT_CLOUD_CONFIG, GREEN_TAXI_TOPIC, FHV_TAXI_TOPIC, RIDES_TOPIC, ALL_RIDE_SCHEMA`
...
⚠️ **Hardcoded Credentials** detected - review required
