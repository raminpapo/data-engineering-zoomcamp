...
**Sections (12)**: Week 2: Workflow Orchestration, Data Lake (GCS), 1. Introduction to Workflow orchestration, 2. Introduction to Prefect concepts, 3. ETL with GCP & Prefect, 4. From Google Cloud Storage to Big Query, 5. Parametrizing Flow & Deployments , 6. Schedules & Docker Storage with Infrastructure, 7. Prefect Cloud and Additional Resources , Code repository

---
*Generated: 2025-11-15T20:48:44.173798*
