...
**Sections (24)**: Introduction, Docker + Postgres, :movie_camera: Introduction to Docker, :movie_camera: Ingesting NY Taxi Data to Postgres, :movie_camera: Connecting pgAdmin and Postgres, :movie_camera: Putting the ingestion script into Docker, :movie_camera: Running Postgres and pgAdmin with Docker-Compose, :movie_camera: SQL refresher, :movie_camera: Optional: Docker Networking and Port Mapping, :movie_camera: Optional: Walk-Through on WSL

---
*Generated: 2025-11-15T20:48:44.073661*
