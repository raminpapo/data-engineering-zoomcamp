...
**Path**: `01-docker-terraform/2_docker_sql/README.md`
**Size**: 11,187 bytes
**Lines**: 489
...
**Sections (12)**: Docker and SQL, Commands , Running Postgres with Docker, Windows, Linux and MacOS, CLI for Postgres, NY Trips Dataset, pgAdmin, Running Postgres and pgAdmin together, Data ingestion

---
*Generated: 2025-11-15T20:48:44.084266*
