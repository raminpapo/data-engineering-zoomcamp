...
**Path**: `06-streaming/python/redpanda_example/README.md`
**Size**: 4,098 bytes
**Lines**: 109
...
**Sections (18)**: Basic PubSub example with Redpanda, 1. Pre-requisites, 2. Docker, 3. Set RPK alias, 4. Kafka Producer - Consumer Examples, Start consumer script, in 1st terminal tab, Start producer script, in 2nd terminal tab, 5. Redpanda UI, 6. rpk commands glossary, set alias for rpk

---
*Generated: 2025-11-15T20:48:44.432221*
