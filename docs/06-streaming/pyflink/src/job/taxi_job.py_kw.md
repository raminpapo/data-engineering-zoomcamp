...
**File**: `06-streaming/pyflink/src/job/taxi_job.py`

## Keyword Index

### EnvironmentSettings

- **Defined in**: [06-streaming/pyflink/src/job/taxi_job.py](./taxi_job.py_docs.md)
...
- **Defined in**: [06-streaming/pyflink/src/job/taxi_job.py](./taxi_job.py_docs.md)
- **Context**: def create_taxi_events_sink_postgres(t_env):

### log_processing

- **Defined in**: [06-streaming/pyflink/src/job/taxi_job.py](./taxi_job.py_docs.md)
- **Context**: def log_processing():
