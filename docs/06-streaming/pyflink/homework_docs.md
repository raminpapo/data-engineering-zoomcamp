...
**Path**: `06-streaming/pyflink/homework.md`
**Size**: 2,662 bytes
**Lines**: 103
...
**Sections (5)**: Homework, Start Red Panda, Flink Job Manager, Flink Task Manager, and Postgres , Question 1. Connecting to the Kafka server, Question 3: Sending the Trip Data, Question 4: Build a Sessionization Window

---
*Generated: 2025-11-15T20:48:44.368344*
