# Documentation: RideRecord.java

## File Metadata

- **Path**: `06-streaming/java/kafka_examples/build/generated-main-avro-java/schemaregistry/RideRecord.java`
- **Size**: 14,594 bytes
- **Lines**: 478
- **Extension**: `.java`
